      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-[#3a1364] border border-[#5a2d8c] rounded-lg shadow-xl z-50">
          ...
          <div className="py-2">
            ...
            <Link href="/settings" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-4 py-3 text-white hover:bg-[#461D7C]">
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/contact-team" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-4 py-3 text-white hover:bg-[#461D7C]">
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
