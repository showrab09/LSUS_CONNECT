...
## 🚀 Features
- **University-only sign-up** with email verification.
- **Marketplace**: Create, edit, search, and filter listings (furniture, books, appliances, etc.).
- **Free/Swap Mode** for giveaways and item exchanges.
- **Events & Announcements Hub** with RSVP functionality.
- **Real-time Chat** using Socket.IO for buyer–seller communication.
- **Admin Dashboard**: moderation tools, flagged content review.
- **Responsive PWA** for mobile-first usage.
